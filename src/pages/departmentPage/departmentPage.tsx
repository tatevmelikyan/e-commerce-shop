...
import { fetchSubDepartments, selectSubDepartmentsByDepartment, selectSubDepartmentsError, selectSubDepartmentsStatus } from './departmentPageSlice'
...
const DepartmentPage: React.FC = () => {
  ...
  const renderedSubDepartments = subDepartments.map(subDepartment => {
    return (
      <div key={subDepartment.id} className="subDepartment">
        <span className="subDepartment-name">
          {subDepartment.name}
        </span>
              ...
              return (
                <div key={category.id} className="category">
                  <Link to={`/${departmentId}/${category.id}`}>
                    <img src={category.imageUrl} alt="category" className="category-image" />
